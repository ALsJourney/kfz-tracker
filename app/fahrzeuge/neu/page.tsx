    ...
    <div className="max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="neu-marke" className="block text-xs font-medium text-gray-600 mb-1">
              Marke *
            </label>
            <input
              id="neu-marke"
          ...
          <div>
            <label htmlFor="neu-modell" className="block text-xs font-medium text-gray-600 mb-1">
              Modell *
            </label>
            <input
              id="neu-modell"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="neu-baujahr" className="block text-xs font-medium text-gray-600 mb-1">
              Baujahr
            </label>
            <input
              id="neu-baujahr"
          ...
          <div>
            <label htmlFor="neu-kennzeichen" className="block text-xs font-medium text-gray-600 mb-1">
              Kennzeichen
            </label>
            <input
              id="neu-kennzeichen"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="neu-farbe" className="block text-xs font-medium text-gray-600 mb-1">
              Farbe
            </label>
            <input
              id="neu-farbe"
          ...
          <div>
            <label htmlFor="neu-km" className="block text-xs font-medium text-gray-600 mb-1">
              Kilometerstand
            </label>
            <input
              id="neu-km"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label htmlFor="neu-kaufpreis" className="block text-xs font-medium text-gray-600 mb-1">
              Kaufpreis (€)
            </label>
            <input
              id="neu-kaufpreis"
          ...
          <div>
            <label htmlFor="neu-tuev" className="block text-xs font-medium text-gray-600 mb-1">
              TÜV / Pickerl bis
            </label>
            <input
              id="neu-tuev"
        ...
        <div>
          <label htmlFor="neu-notizen" className="block text-xs font-medium text-gray-600 mb-1">
            Notizen
          </label>
          <textarea
            id="neu-notizen"
