      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
        <div>
          ...
          <p className="text-on-surface-variant text-base font-geist">
            Alle Fahrzeuge mit Details und Kostenübersicht.
          </p>
        </div>
                ...
                <div className="mt-auto pt-6 flex flex-col gap-4">
                  {f.kilometerstand > 0 && (
                    <div className="flex items-center gap-2 text-on-surface-variant">
                      ...
                      <span className="text-base font-geist" style={{ fontVariantNumeric: "tabular-nums" }}>
                  ...
                  <div className="bg-surface-container-low rounded-lg p-3 flex justify-between items-center ring-1 ring-outline-variant/5">
                    ...
                    <span className="text-sm font-semibold text-on-surface font-geist" style={{ fontVariantNumeric: "tabular-nums" }}>
                      {formatEuro(total)}
                    </span>
                  </div>
